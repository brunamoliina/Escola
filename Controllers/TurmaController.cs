    ...
    public class TurmaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Turma != null ? 
                          ...
                          Problem("Entity set 'Context.Turma'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Ativo")] Turma turma)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Ativo")] Turma turma)
        {
            if (id != turma.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Context.Turma'  is null.");
            }
            var turma = await _context.Turma.FindAsync(id);
            if (turma != null)
            {
